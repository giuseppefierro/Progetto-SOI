...
(function () {
  ...
  function addTask(form) {
    //Prova di aggiunta dato da 3 campi
    //Come aggiungere a schermo la visualizzazione di tutti i campi?
    /*
    const inp_0 = form.querySelectorAll('input')[0];
    const inp_1 = form.querySelectorAll('input')[1];
    const inp_2 = form.querySelectorAll('input')[2];
    const desc_0 = (inp_0.value || '').trim();
    const desc_1 = (inp_1.value || '').trim();
    const desc_2 = (inp_2.value || '').trim();
    */
